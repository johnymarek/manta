...
<!--		  <script>getPageInfo("pageTitle");</script>-->
		  <script>sprintf("YouTube playlist",focus-(-1));</script>
		</text>
...
<image redraw="yes" offsetXPC="2.5" offsetYPC="4" widthPC="8" heightPC="11">'.$DIR_SCRIPT_ROOT.'image/youtubeplu.jpg</image>
...
if($query) {
   ...
   $page = $queryArr[0];
   $search = $queryArr[1];
   $nazev = urldecode($queryArr[2]);
}

$link="http://gdata.youtube.com/feeds/api/playlists/".$search."?v=2&orderby=position&start-index=".$page."&max-results=25";
...
foreach($videos as $video) {
	$id = str_between($video,"<link rel='alternate' type='text/html' href='http://www.youtube.com/watch?v=","&amp;feature=youtube_gdata'/>");
